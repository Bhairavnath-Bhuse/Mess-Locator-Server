...
exports.signUp = async (req,res) =>{
    ...
    //return res 
        ...
        try{
            ...
            if(!firstName || !lastName || !email || !password || !confirmPassword || !otp || !accountType){                //validate krlo means all inbox are filled or not;
            ...
            // Create the user
            let approved = "";
            approved === "MessOwner" ? (approved = false) : (approved = true);
...
exports.login = async (req,res) =>{
    ...
    //generate JWT, after password matching/comparin
    // generate payload;
